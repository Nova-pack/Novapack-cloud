        ...
        <div style="display:flex; flex-direction:column; height:100%; background:#1e1e1e; color:#d4d4d4; font-family:'Segoe UI',sans-serif;">
            ...
            <div style="background:linear-gradient(135deg, #0d47a1, #1565c0); padding:14px 24px; display:flex; justify-content:space-between; align-items:center; flex-shrink:0;">
                ...
                <div style="display:flex; gap:8px; align-items:center;">
                    ...
                    <!-- PRIMARY: \u26a1 Entrada R\u00e1pida (rejilla CRM de teclado) -->
                    <button type="button" onclick="if(window.openEntradaRapida) window.openEntradaRapida(); else alert('M\u00f3dulo no cargado. Recarga la p\u00e1gina.');" title="Rejilla de entrada masiva por teclado: fila = albar\u00e1n, ENTER = siguiente, sin clicks" style="background:linear-gradient(135deg,#FF6600,#FFB300); border:none; color:#1a1a1a; padding:8px 18px; border-radius:6px; cursor:pointer; font-weight:900; font-size:0.85rem; display:flex; align-items:center; gap:5px; box-shadow:0 2px 8px rgba(255,179,0,0.4); transition:all 0.2s;" onmouseover="this.style.transform='translateY(-1px)';this.style.boxShadow='0 4px 12px rgba(255,179,0,0.5)'" onmouseout="this.style.transform='';this.style.boxShadow='0 2px 8px rgba(255,179,0,0.4)'">
                        <span class="material-symbols-outlined" style="font-size:1rem;">bolt</span> ENTRADA R\u00c1PIDA
                    </button>
